...
const easing = Easings.time('sineInOut', 8000);
...
const use = () => {
  ...
  const hsl = `hsl(170, ${saturation}%, 50%)`; // Update the hue value to 120 for green
...
const update = () => {
  const { value, targetValue, speed, easingValue } = state;
